...
Feature: US017 TC01 Teacher, öğrencilere not verebilmelidir
  @smoke
  Scenario Outline: Ogrenci not verme senaryosu
    ...
    Examples:
      ...
      | Team10Cucumber | Team10Student Team10  | FALL_SEMESTER         | 3        | 70           | 90         | Dönem Başarılı*10* |